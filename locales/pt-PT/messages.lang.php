...
$GLOBALS['__l10n']["(still undefined)"]="(Ainda não definido)";
...
$GLOBALS['__l10n']["Access Control Mode"]="Modulo de controlo de acessos";
...
$GLOBALS['__l10n']["Activity"]="Actividade";
$GLOBALS['__l10n']["Activity Editor"]="Editor de actividade";
$GLOBALS['__l10n']["Activity or Connector"]="Actividade ou conectado";
$GLOBALS['__l10n']["Activity Variables"]="Variáveis de actividade";
...
$GLOBALS['__l10n']["Browse Tests"]="Navegar nos testes";
$GLOBALS['__l10n']["Browse the ontology."]="Navegar na ontologia";
$GLOBALS['__l10n']["Build processes to drive activities into a workflow."]="Construir processos para conduzir as actividades em um fluxo de trabalho.";
...
$GLOBALS['__l10n']["Check All"]="Marcar Todos";
$GLOBALS['__l10n']["check code"]="Verificar código";
$GLOBALS['__l10n']["checking the code..."]="A verificar o código...";
...
$GLOBALS['__l10n']["Close all"]="Fechar tudo";
$GLOBALS['__l10n']["Close tab"]="Fechar separador";
$GLOBALS['__l10n']["Code"]="Código";
$GLOBALS['__l10n']["Code already used"]="O código já está em uso";
...
$GLOBALS['__l10n']["Compilation"]="Compilação";
$GLOBALS['__l10n']["Confirm"]="Confirmar";
$GLOBALS['__l10n']["Connector"]="Conector";
$GLOBALS['__l10n']["Connector Type"]="Tipo de conector";
$GLOBALS['__l10n']["Constant"]="Constante";
$GLOBALS['__l10n']["Country"]="Pais";
...
$GLOBALS['__l10n']["create new activity"]="Criar nova actividade";
$GLOBALS['__l10n']["create new connector"]="Criar novo conector";
$GLOBALS['__l10n']["CSV"]="CSV";
$GLOBALS['__l10n']["CSV Options"]="Opções de CSV";
$GLOBALS['__l10n']["Current activities"]="Actividades actuais";
$GLOBALS['__l10n']["Current Activities"]="Actividades Actuais";
...
$GLOBALS['__l10n']["Current User"]="Utilizador actual";
...
$GLOBALS['__l10n']["Formal Parameter"]="Parâmetro Formal";
...
$GLOBALS['__l10n']["IF"]="SE";
$GLOBALS['__l10n']["If"]="Se";
$GLOBALS['__l10n']["Import"]="Importar";
$GLOBALS['__l10n']["Import "]="Importar";
$GLOBALS['__l10n']["Import failed"]="Falha ao importar";
$GLOBALS['__l10n']["Inclusive (AND)"]="Inclusive (AND)";
$GLOBALS['__l10n']["Input Parameters"]="Parâmetros de entrada";
$GLOBALS['__l10n']["Inspect Results"]="Inspeccionar resultados";
...
$GLOBALS['__l10n']["interactive service saved"]="Serviço interactivo guardado";
...
$GLOBALS['__l10n']["loading..."]="A carregar...";
...
$GLOBALS['__l10n']["Manage campaigns"]="Gerir campanhas";
...
$GLOBALS['__l10n']["Manage processes"]="Gerir processos";
$GLOBALS['__l10n']["Manage Results"]="Gerir resultados";
...
$GLOBALS['__l10n']["Manage services"]="Gerir serviços";
...
$GLOBALS['__l10n']["Media Manager"]="Gestor de mídia";
$GLOBALS['__l10n']["Merge to "]="Enviar para";
$GLOBALS['__l10n']["meta data"]="meta dados";
$GLOBALS['__l10n']["Meta Data"]="Metadados";
$GLOBALS['__l10n']["minimum value: "]="Valor mínimo:";
$GLOBALS['__l10n']["Monitor processes"]="Monitor de processos";
$GLOBALS['__l10n']["Monitoring processes"]="Processos de monitorização";
...
$GLOBALS['__l10n']["new process"]="novo processo";
$GLOBALS['__l10n']["new role"]="Novo papel";
$GLOBALS['__l10n']["newly edited"]="Editado recentemente";
$GLOBALS['__l10n']["Next"]="Próximo";
...
$GLOBALS['__l10n']["Open all"]="Abrir todos";
...
$GLOBALS['__l10n']["Output Parameters"]="Parâmetros de saída";
...
$GLOBALS['__l10n']["please choose another one"]="Por favor escolha outro";
$GLOBALS['__l10n']["Please confirm deletion"]="Por favor confirme a eliminação";
$GLOBALS['__l10n']["Please confirm deletion.\n Warning: related resources might be affected."]="Por favor, confirme a eliminação. / N  Aviso: os recursos relacionados podem ser afectados.";
$GLOBALS['__l10n']["Please confirm property deletion!"]="Por favor confirme a eliminação da propriedade";
$GLOBALS['__l10n']["Please confirm the deletion of the connector: \n child connectors will be delete at the same time"]="Por favor, confirme a eliminação do conector: / n  conectores dependentes serão eliminados ao mesmo tempo";
...
$GLOBALS['__l10n']["Please select a delivery before authoring it"]="Por favor seleccione uma distribuição antes de criar";
$GLOBALS['__l10n']["Please select a process before authoring it"]="Por favor seleccione um processo antes de criar";
$GLOBALS['__l10n']["Please upload an RDF file."]="Por favor envie o ficheiro RDF.";
$GLOBALS['__l10n']["Positionning"]="Posicionamento";
$GLOBALS['__l10n']["Prepare, publish deliveries sessions."]="Prepare, publique sessões de distribuição.";
$GLOBALS['__l10n']["Preparing installation..."]="A preparar instalação";
$GLOBALS['__l10n']["Preview"]="Prever";
$GLOBALS['__l10n']["Process authoring"]="Processo de criação";
$GLOBALS['__l10n']["Process Definition"]="Processo de definição";
$GLOBALS['__l10n']["Process Execution"]="Processo de exclusão";
$GLOBALS['__l10n']["Process History"]="Processo de histórico";
$GLOBALS['__l10n']["Process Property"]="Processo de propriedade";
$GLOBALS['__l10n']["Process saved"]="Processo guardado";
$GLOBALS['__l10n']["Process Tree:"]="Arvore do processo:";
$GLOBALS['__l10n']["Process Variable"]="Variável do processo";
$GLOBALS['__l10n']["Process Variables"]="Variáveis de processo";
$GLOBALS['__l10n']["Processes"]="Processos";
$GLOBALS['__l10n']["Processes library"]="Biblioteca de processos";
...
$GLOBALS['__l10n']["reload"]="recarregar";
$GLOBALS['__l10n']["reloading form..."]="recarregar formulário";
...
$GLOBALS['__l10n']["Restricted to"]="restringido a";
...
$GLOBALS['__l10n']["Select a test"]="Seleccione um teste";
...
$GLOBALS['__l10n']["Service Definition"]="Definição de serviço";
$GLOBALS['__l10n']["Service library"]="Biblioteca de serviço";
$GLOBALS['__l10n']["Set the activity as a final one will delete its following connector. \n Are you sure?"]="Definir esta actividade como uma actividade final irá apagar seu seguinte conector. / n  Tem certeza?";
...
$GLOBALS['__l10n']["the chosen code has already been used for the process variable"]="O código escolhido já foi usado por um processo de variável";
...
$GLOBALS['__l10n']["The Processes module allows to create Processes."]="O modulo de processo permite criar processos.";
...
$GLOBALS['__l10n']["Unable to delete the process execution.\nClose process before delete it."]="Não é possível eliminar a execução do processo. / N Feche processo antes de eliminar.";
$GLOBALS['__l10n']["Uncheck All"]="Desmarcar Todos";
$GLOBALS['__l10n']["Uncheck all"]="Desmarcar todos";
$GLOBALS['__l10n']["Unit"]="unidade";
...
$GLOBALS['__l10n']["Use the * character to replace any string"]="Use o caracter * para substituir qualquer sequência";
...
$GLOBALS['__l10n']["Variables"]="Variáveis";
$GLOBALS['__l10n']["Version"]="Versão";
$GLOBALS['__l10n']["Versioning"]="Versionamento";
$GLOBALS['__l10n']["VFF"]="VFF";
$GLOBALS['__l10n']["VFF version"]="Versão de VFF";
$GLOBALS['__l10n']["View and format the collected results."]="Ver e formatar resultados colhidos";
$GLOBALS['__l10n']["Welcome to TAO!"]="Bem-vindo ao TAO!";
$GLOBALS['__l10n']["XLIFF"]="XLIFF";
$GLOBALS['__l10n']["XLIFF version"]="Versão de XLIFF";
